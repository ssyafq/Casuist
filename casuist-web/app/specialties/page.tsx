...
const specialties = [
  { name: 'Cardiology', emoji: '🫀', cases: 124, slug: 'cardiology' },
  { name: 'Respiratory', emoji: '🫁', cases: 98, slug: 'respiratory' },
  { name: 'Neurology', emoji: '🧠', cases: 72, slug: 'neurology' },
  { name: 'Gastroenterology', emoji: '🔬', cases: 56, slug: 'gastroenterology' },
  { name: 'Endocrinology', emoji: '⚗️', cases: 43, slug: 'endocrinology' },
]
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {specialties.map((s) => (
                ...
                >
                  ...
                  <span className="text-slate-500 text-sm font-medium font-mono">{s.cases} cases</span>
                </Link>
              ))}
